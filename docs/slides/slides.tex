...
1. Introducing vol surface(bs, implied vol + examples) \\
2. VAE review - theory and image application\\
3. models and usage, VAE, vae pointwise(replicating)\\
4. dataset introduction - eg:fig\\
...
\end{itemize}
\textbf{Pointwise VAE (Bergeron et al., 2021):}
\begin{itemize}
